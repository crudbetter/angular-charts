describe('linechart directive with static series', function() {
	it('should render', function() {
		browser.get('http://127.0.0.1:8000/test/linechart/staticHarness.html');
		browser.takeScreenshot().then(function(data) {
  		browser.driver.get('http://127.0.0.1:8000/test/linechart/expected/two_lines_alternating_points.html');
...
describe('linechart directive with dynamic series', function() {
  it('should render', function() {
    browser.get('http://127.0.0.1:8000/test/linechart/dynamicHarness.html');
